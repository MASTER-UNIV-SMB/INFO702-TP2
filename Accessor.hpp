...
#ifndef _ACCESSOR_HPP
#define _ACCESSOR_HPP
...
struct ColorBlueAccessor {
    ...
    // Acces en lecture.
    static Value access(const Argument &arg) { return arg.blue; }

    // Acces en écriture.
    static Reference access(Argument &arg) { return ColorBlueReference(arg); }
};
...
struct ColorRedAccessor {
    ...
    // Acces en lecture.
    static Value access(const Argument &arg) { return arg.red; }

    // Acces en écriture.
    static Reference access(Argument &arg) { return ColorRedReference(arg); }
};
...
struct ColorValueAccessor {
    ...
    static Reference access(Argument &arg) { return ColorValueReference(arg); }
};
